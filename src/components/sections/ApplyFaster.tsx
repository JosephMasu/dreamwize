        ...
        <ul className="space-y-9">
          {[
            ...
            <li key={index} className="flex items-start md:-py-2">
              <Image src={step.imgSrc} alt={step.title} width={32} height={32} className="mr-2 border-dream-green bg-dream-bg-green border-2 rounded-md md:w-[40px] md:h-[40px] w-[44px] h-[44px] flex items-center justify-center " />
              <div>
